...
contract FlightSuretyApp {
    ...
    */
    ...
    {
        bool result = flightSuretyData.registerAirline(airlineAddress, name);
        if (result == true) {
    ...
    */
    function processFlightStatus
                                ...
                                requireIsOperational
    {
        bytes32 keyVal = keccak256(abi.encodePacked(flight, airline));
        require(flights[keyVal].isRegistered, "Flight is not registered.");

        flights[keyVal].updatedTimestamp = timestamp;
        flights[keyVal].statusCode = statusCode;
    ...
    {
            bytes32 keyVal = keccak256(abi.encodePacked(flight, airline));
            return flights[keyVal].statusCode;
    }
