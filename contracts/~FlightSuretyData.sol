...
contract FlightSuretyData {
    ...
    */
                            ...
                            returns (bool)
    {
        ...
        require(!airlines[airlineAddress].isRegistered, "This Airline is already registered.");
    ...
    */
                            ...
                            returns (uint256, address, uint256)
    {
        ...
        require(msg.value > 0, 'You need to pay atleast some ETH to buy a flight insurance');
    ...
    */
                            ...
                            returns (uint256, uint256, uint256, uint256, address, address)
    {
        ...
        require(address(this).balance > credit, "The contract is out of funds to pay the credit");
